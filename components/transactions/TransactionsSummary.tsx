...
export default function TransactionsSummary({transaction}:{transaction:Transaction}) {

    
    return (
      <>
        <div key={transaction.id} className='mt-6  text-sm font-medium text-gray-500 border border-gray-200'>
